<x-layouts.storefront title="New Arrivals · Inkbloom Co.">

{{-- Hero --}}
<section class="py-16 px-6" style="background: linear-gradient(135deg,#FF4D6D 0%,#E4D6FF 100%);">
  <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 items-center">
    <div>
      ...
      <p class="hand text-2xl text-white/80 mb-2">just landed</p>
      <h1 class="font-display text-5xl md:text-6xl text-white leading-tight">New Arrivals</h1>
      <p class="mt-4 text-white/80 leading-relaxed">The newest additions to the bloom. Fresh in, too good to miss.</p>
      <div class="mt-6 flex gap-3 flex-wrap">
        <span class="chip bg-white/20 text-white border-white/20">{{ $products->total() }} new products</span>
        <span class="chip bg-white/20 text-white border-white/20">🌸 Just arrived</span>
      </div>
    </div>
  ...
  <div class="max-w-7xl mx-auto">
    @if($products->isEmpty())
      <div class="text-center py-20">
        ...
        <h3 class="font-display text-2xl">New arrivals dropping soon</h3>
        <p class="text-fog mt-2">Something beautiful is on its way. Subscribe to be the first to know.</p>
